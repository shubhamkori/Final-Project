...
<html>
    ...
    <body class="bg-gray-100">
       ...
       <div class="flex flex-col items-center justify-center text-center py-10">
        ...
        <form action="{{url('tweeter')}}" method="POST" enctype="multipart/form-data" class="px-4 my-32 max-w-3xl mx-auto space-y-6">
            @csrf
            <div class="flex flex-col items-center justify-center text-center">
                <h1 class="font-semibold text-7xl">Tweet</h1>
            </div>
    ...
    <div class="w-1/2">
        ...
        <a href="/" class="text-white text-lg bg-green-500 py-2 px-4 w-full rounded focus:outline-none"><-Back </a>
